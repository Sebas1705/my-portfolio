...
describe('GetSkillsUseCase', () => {
    ...
    it('should return skills with non-empty identifiers', async () => {
        const skills = await useCase.execute();
